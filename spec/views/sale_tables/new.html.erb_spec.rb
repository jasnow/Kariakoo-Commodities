...
describe "sale_tables/new" do
  before(:each) do
    assign(:sale_table, stub_model(SaleTable,
  ...
  it "renders new sale_table form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => sale_tables_path, :method => "post" do
